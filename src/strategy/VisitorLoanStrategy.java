 ...
 */
public class VisitorLoanStrategy implements ILoanStrategy {

    @Override
    public int loanDays() {
        return 5; // Determina cuantos dias tiene permitido prestar un libro
    }
    ...
    public int accessPriority() {
        return 1; // Determina la prioridad
    }
